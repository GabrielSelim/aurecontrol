...
INSERT INTO auth.users (id, instance_id, aud, role, email, encrypted_password, ${CONFIRM_COL}, created_at, updated_at, raw_app_meta_data, raw_user_meta_data, is_super_admin) VALUES
